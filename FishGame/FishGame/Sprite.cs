...
namespace FishGame
{
    class Sprite
    {
        ...
        public Sprite(Screen gState, string file)
        {
            _gState = gState;
            _texture = _gState.content.Load<Texture2D>(file);
        ...
        public void Draw()
        {
            _gState.spriteBatch.Draw(_texture, _position, _sourceRect, _tint, _rotation, _pivot, _scale, SpriteEffects.None, _layer);
        }
    }
}
